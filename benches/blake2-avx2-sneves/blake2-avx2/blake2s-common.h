...
#define ROT16128(x) _mm_ror_epi32((x), 16)
#define ROT12128(x) _mm_ror_epi32((x), 12)
#define ROT8128(x) _mm_ror_epi32((x), 8)
#define ROT7128(x) _mm_ror_epi32((x), 7)
...
#define ROT16(x) _mm256_ror_epi32((x), 16)
#define ROT12(x) _mm256_ror_epi32((x), 12)
#define ROT8(x) _mm256_ror_epi32((x), 8)
#define ROT7(x) _mm256_ror_epi32((x), 7)
